# 👋 Hi, I'm Francisco Tavares

🎓 Final-year Computer Engineering student @ ISEL, Current Grade: 16.37/20

📍 Lisbon, Portugal  

💻 Backend • Distributed Systems & System Design • Security  

I focus on building reliable backend systems and solving complex engineering problems.  
Strong interest in distributed systems, concurrency and system design.
Driven by understanding how systems behave, interact and scale under the hood.

---

## 🧠 About Me

- Strong problem-solving mindset and logical-mathematical thinking  
- Solid background in backend development and concurrent systems  
- Experience designing multi-user systems and real-time applications  
- Interested in distributed systems (cloud), backend and security  

## 🛠️ Technologies

Kotlin • Java • C • Spring • PostgreSQL • Docker  
